...
def getKeypoints(camera):
    if camera == 'ME':
        ...
        pts_src = np.array([[747,697],[1105,696],[750,415],[1080,427],[1053,132],[1680,435],[144,408]])
        pts_dst = np.array([[996,404],[998,564],[1132,400],[1127,565],[1305,565],[1128,859],[1132,104]])
