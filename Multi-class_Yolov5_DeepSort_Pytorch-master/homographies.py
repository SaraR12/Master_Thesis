...
def getKeypoints(camera):
    if camera == 'WN2':
        ...
        pts_src = np.array([[1152,559],[687,590],[658,87],[1382,753],[905,49],[664,211],[679,462]])
        pts_dst = np.array([[1569,860],[1304,860],[1305,564],[1676,967],[1454,565],[1304,638],[1305,786]])
        return pts_src, pts_dst
