...
def consumer():
    ...
    prev_time = time.time()
    heatmap_obj = HeatMap(VIDEOFRAME, timesteps=1)
    ...
    while i < 300:
        ...
        if i > 0:
            ...
            if all([qWNList, qMSWList, qNSList, qMList, qENList, qMEList, qWN2List]): # True if all not 0
                ...
                if frame > 1:
                    img2 = draw_bboxes(intersected_bboxes, VIDEOFRAME, filter_listUKF)
                else:
                ...
                if frame == 1:
                    ...
                    if unassociated_measurements != []:
                        ...
                        #filter_listUKF.append(addedFilter[0])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--streamPath')
