...
zs = np.array([[91.852,726.34], [93, 727], [96, 727], [97, 726], [100, 726], [103, 724], [108, 726], [112, 726],
...
ax1.plot(xz, yz, linewidth=2 ,label='Measurement')
ax1.plot(xu, yu, color='red', label='Filtered trajectory')
ax1.plot(xtrue, ytrue, color='black', label='True trajectory')
ax1.legend()

ax2.plot(xz2, yz2, linewidth=2 ,label='Measurement')
ax2.plot(xu2, yu2, color='red', label='Filtered trajectory')
ax2.plot(xtrue, ytrue, color='black', label='True trajectory')
ax2.legend()
